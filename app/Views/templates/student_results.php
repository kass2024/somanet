...
<div style="width: 100%;padding: 15px">
	<div style="float:left;">
		<span><b>REPUBLIC OF RWANDA</b></span><br>
		<span><b>MINISTRY OF EDUCATION</b></span><br>
	...
	<br>
	<h4 style="text-decoration: underline;width: 100%;float: left;text-align: center;">Period <?=$period;?> Student periodic result from <?=$class;?></h4>
</div>
