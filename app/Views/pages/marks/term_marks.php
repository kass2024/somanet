...
<form action="<?= base_url('student_term_results/1'); ?>" method="post" class="validate" target="_blank" id="form">
	<div class="row" style="background-color: white;height: auto;padding: 10px">
		...
		<div class="form-group col-sm-3 col-md-3 col-lg-3">
			...
			<select class="select2" id="select_course" name="course" required>
		...
		if ($school_id==5) {
			...
			<div class="form-group col-sm-3 col-md-2 col-lg-2">
				...
				<select class="form-control select2" id="type" name="type" required>
					...
					<option value="7">MID </option>
					<option value="8">EOT </option>
				</select>
			</div>
			<?php
		} ?>
