<div class="app-inner-layout app-inner-layout-page">
	<div class="app-inner-layout__wrapper" style="display: block;padding-left: 20px">
		...
		<div style="margin-top: 15px;width: 100%;float:left;">
			<form action="<?= base_url('manipulate_discipline_entry'); ?>" class="autoSubmit validate" method="POST">
				...
				<div class="col-md-5 col-sm-12 pull-left">
					<div style="background:white;padding: 10px">
						...
						<div class="row" style="margin-top: 15px;" id="reduce_marks">
							<div class="col-md-3 pull-left">
								<label><?= lang("app.reducedMarks");?></label>
							</div>
							<div class="col-md-9 pull-left">
							...
							<div class="col-md-12 pull-left">
								...
								<center>
									<button type="submit" class="btn btn-success btn-lg"
											...
											data-target="<?= base_url('/discipline_record_entry'); ?>"><i
											class="fa fa-check"></i>
										<?= lang("app.save");?>
									</button>
								</center>
...
<script>
	...
	function formatRepoSelection(repo, isClass = false) {
		...
		if (isError)
			return;
		$.get("<?=base_url();?>get_student/" + id + cl, function (data) {
			if (isClass) {
