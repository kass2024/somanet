...
<!--							</tr>-->
					...
					<td colspan=\"10\" style=\"background-color: #f5e1b9\"><b>&nbsp;</b></td>
							...
							<tr>
								...
								$em = strlen($datas['exam_marks'])==0?'-':number_format($datas['exam_marks'], 1);
								$tm = (strlen($datas['exam_marks'])==0 && strlen($datas['marks'])==0)?'-':number_format($total, 1);
								echo "<td class='$catEchec'>" . $cm . "</td>
								      <td class='$ExamEchec'>" . $em . "</td>
