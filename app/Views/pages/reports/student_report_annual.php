				...
				<div style="background:white;">
					<div style="height: 98%">
						<h4 style="text-align: center;float: left;width: 100%;margin: 20px 0 16px 0;font-size: 19px;font-weight: bold;">
							<?= lang('app.annualSchoolReport'); ?></h4>
						<table class="tablepage" border="1">
							...
							<tr>
								...
								<td colspan="3" class="colscenter bold-right"><?= lang('app.annual'); ?></td>
								<td colspan="1" class="colscenter"><?= lang('app.secondSitting'); ?></td>
							</tr>
							<tr>
					...
					<td colspan=\"20\" style=\"background-color: #f5e1b9\"><b>&nbsp;</b></td>
									...
									echo "<tr>
					<td colspan=\"20\" style=\"background-color: #f5e1b9\"><b>" . strtoupper($core['category']) . "</b></td>
				</tr>";
								}
